...
export function HeroSection() {
  return (
    <section className="relative bg-[#0F172A] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(194,65,12,0.08),transparent_70%)] pointer-events-none" />
      {/* Grid texture */}
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 md:pt-36 md:pb-28 pointer-events-none">
        <div className="md:max-w-[50%]">
          <AnimatedSection>
            {/* Eyebrow */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.06] border border-white/[0.08] mb-6 pointer-events-auto">
