...
// Settings grouped into three sections (presentational regroup). Every route is
// preserved 1:1 from the prior flat MORE_ITEMS list; Customers + Calendar are
// added under Business for mobile parity (both are otherwise unreachable on
// mobile — Customers has no bottom-bar slot, Calendar is desktop-sidebar only).
const MORE_SECTIONS = [
  {
    label: 'Business',
    items: [
      ...
      { href: '/dashboard/customers', label: 'Customers', description: 'View and manage your customer records', icon: Contact },
      { href: '/dashboard/calendar', label: 'Calendar', description: 'View appointments and manage your schedule', icon: Calendar },
    ],
  },
  {
    label: 'AI & Calls',
...
export default function MorePage() {
  ...
  // Invoice Settings stays gated by the invoicing flag (unchanged behavior).
  // Drop any section that ends up empty after filtering.
  ...
  return (
    <div data-tour="more-page">
      ...
      {/* Settings — grouped into Business / AI & Calls / Billing & Money */}
