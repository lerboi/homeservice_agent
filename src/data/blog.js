export const BLOG_POSTS = [
  {
    ...
    excerpt:
      "You can't answer the phone while you're under a sink. Here's how AI changes that.",
    publishedAt: '2025-11-01',
    featuredImage: '/images/blog/ai-receptionist-plumber.jpg',
    content: `## The $650 Call You Missed Today
...
- **Understands the job type.** Burst pipe, drain clog, water heater replacement, or routine maintenance? The AI identifies the service category from the caller's description and routes the interaction accordingly.
- **Detects emergencies.** If a caller says "water everywhere" or "I smell gas," Voco flags it as a priority, books them into the next available slot — which may be the same day — and sends you a priority SMS alert.
- **Books the appointment.** Voco checks your real calendar (synced with Google Calendar or Outlook), finds the next open slot with travel time buffers, and confirms the booking with the caller while they are still on the phone.
- **Captures all the details.** Name, address, phone number, job description — everything you need is saved to your CRM dashboard before you ever see the notification.
...
- **Hold times.** Human operators handle multiple clients. Your callers wait on hold while operators finish calls from other businesses.
- **Limited hours.** Most answering services cover evenings and weekends, but have gaps during transition hours.
- **Inconsistent quality.** The operator taking the call might not understand plumbing terminology, might quote wrong availability, or might fail to capture the urgency of a burst pipe.
- **No calendar integration.** Human operators take messages. They don't book into your actual calendar.
...
1. Booked into same-day slots (if available) or the earliest possible slot
2. Tagged as emergency in your CRM dashboard
3. Sent to you via priority SMS alert with the caller's name, address, and job description
...
1. **Sign up and select your trade** — Voco pre-loads plumbing-specific service categories and questions
2. **Set your hours** — business hours, emergency availability, lunch breaks
3. **Connect your calendar** — Google Calendar or Outlook, takes about 2 minutes
4. **Get your Voco phone number** — forward your existing number or use the new one
...
- **Transfer option.** Voco can offer to transfer to your cell for calls you've configured as "always transfer" (existing customers, VIP clients).
- **Take a message.** For non-booking inquiries, Voco captures the message and reason, sends you a notification, and lets you respond at your convenience.
...
|----------|-------------|----------|
| Calls missed per week | 5-8 | 0 |
| Callers who don't leave voicemail | 80% (4-6 calls) | N/A |
| Jobs lost to competitors | 3-5/week | 0 |
| Revenue lost per week | $1,950-$3,250 | $0 |
| Monthly cost | $0 | $249 |
...
Your competitors are still using voicemail. For now.`,
    relatedSlugs: ['ai-receptionist-for-hvac', 'ai-receptionist-for-electricians'],
  },
  {
    slug: 'ai-receptionist-for-hvac',
    title: 'How HVAC Companies Are Booking 30% More Jobs With AI Receptionists',
    excerpt:
      'When temperatures hit extremes, every missed call is a lost emergency job. AI changes the game for HVAC contractors.',
...
Your competitors are still asking callers to leave a message. With Voco, every caller gets an answer and an appointment.`,
  ...
  },
  {
    ...
    excerpt:
      "Electrical work requires focus — and focus means missed calls. Here's the fix that's saving electricians thousands per month.",
