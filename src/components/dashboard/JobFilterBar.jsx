...
// Phase 59 Plan 06: JobFilterBar — clone of LeadFilterBar.
// Status enum swapped to jobs statuses (handled by JobStatusPills strip above;
// no inline status select here — same pattern as LeadFilterBar).
...
// Status is handled by the JobStatusPills strip above the filter bar — it has
