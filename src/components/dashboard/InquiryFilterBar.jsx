...
// Phase 59 Plan 06: InquiryFilterBar — clone of JobFilterBar for the Inquiries tab.
// Status options: open | converted | lost (handled by InquiryStatusPills strip above).
// D-07a INVARIANT: NO "Stale" or "Needs follow-up" filter preset in this component.
...
// Status is handled by the InquiryStatusPills strip above the filter bar — intentionally absent here.
// D-07a: NO "Stale" filter preset. Stale-inquiry concept does not exist in V1.
const PILL_LABELS = {
...
export default function InquiryFilterBar({ filters, onFilterChange, onClear }) {
      ...
      <div className="flex items-center gap-3">
        ...
        <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
          ...
          <SheetContent side="bottom" className="rounded-t-2xl pb-6">
            <SheetHeader>
              <SheetTitle>Filter inquiries</SheetTitle>
            </SheetHeader>
