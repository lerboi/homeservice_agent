...
-- Signature from 025_fix_book_appointment_atomic.sql:
--   book_appointment_atomic(uuid, uuid, timestamptz, timestamptz, text, text, text, text, uuid)
REVOKE EXECUTE ON FUNCTION public.book_appointment_atomic(uuid, uuid, timestamptz, timestamptz, text, text, text, text, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.book_appointment_atomic(uuid, uuid, timestamptz, timestamptz, text, text, text, text, uuid) TO service_role;
