...
- [ ] **VOICE-05**: AI detects caller's language on first utterance and switches to appropriate language seamlessly
- [ ] **VOICE-06**: AI handles code-switching (Singlish/Spanish/mixed language) without breaking conversation flow
- [ ] **VOICE-07**: Per-business custom greeting script and AI persona configurable by owner
- [ ] **VOICE-08**: Call recording stored and accessible per lead in dashboard
- [ ] **VOICE-09**: Call transcript generated and stored per lead in dashboard
