...
| 48-05-01 | 05 | 3 | HOME-04, HOME-05, HOME-06 | T-48-16, T-48-18 | Context-only message rendering; hardcoded help hrefs; ChatMessage sanitization inherited | unit | `npx jest tests/unit/chat-panel.test.js tests/unit/help-discoverability.test.js --no-coverage` | ✅ | ✅ green |
| 48-05-02 | 05 | 3 | HOME-04, HOME-05, HOME-06, HOME-07 | T-48-17, T-48-19 | No inline missed-calls alert / Invoices card / setupMode; `position: sticky` adds no JS listeners | static + unit | `grep -q "DailyOpsHub" src/app/dashboard/page.js && grep -q "ChatPanel" src/app/dashboard/page.js && grep -q "HelpDiscoverabilityCard" src/app/dashboard/page.js && grep -q "SetupChecklist" src/app/dashboard/page.js && grep -q "RecentActivityFeed" src/app/dashboard/page.js && ! grep -q "Invoices" src/app/dashboard/page.js && ! grep -q "REQUIRED_IDS" src/app/dashboard/page.js && ! grep -q "setupMode" src/app/dashboard/page.js && npx jest --testPathPattern="tests/unit/(setup-checklist\|usage\|chat-provider\|chat-panel\|help-discoverability)" --no-coverage` | ✅ | ✅ green |
| 48-05-03 | 05 | 3 | HOME-07, HOME-05 | — | See Manual-Only Verifications table below | manual (checkpoint) | `grep -q "nyquist_compliant: true" .planning/phases/48-dashboard-home-redesign/48-VALIDATION.md && grep -q "Approval: approved" .planning/phases/48-dashboard-home-redesign/48-VALIDATION.md` | ✅ | ⬜ pending (awaiting 375px human-verify) |
