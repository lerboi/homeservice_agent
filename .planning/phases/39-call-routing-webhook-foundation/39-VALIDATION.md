...
| **Full suite target size** | 35 tests (17 schedule + 8 caps + 6 routes + 4 security) |
...
| 39-03-T2 Fill in test_schedule.py (17 tests) | 39-03 | 1 | ROUTE-04 | unit | `cd livekit-agent && pytest tests/webhook/test_schedule.py -x` | livekit-agent/tests/webhook/test_schedule.py | ⬜ pending |
...
| 39-04-T2 Create src/webhook/caps.py (8 tests) | 39-04 | 1 | ROUTE-05 | unit | `cd livekit-agent && pytest tests/webhook/test_caps.py -x` | livekit-agent/src/webhook/caps.py | ⬜ pending |
...
- [x] `livekit-agent/tests/webhook/test_schedule.py` — 17 stubs for every success-criterion #4 sub-case
- [x] `livekit-agent/tests/webhook/test_caps.py` — 8 stubs for every success-criterion #5 sub-case
