...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/leroyngzz/Projects/homeservice_agent/.claude
                  → checks /Users/leroyngzz/Projects/homeservice_agent/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done
                  → writes to /Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/hooks/
...
@/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
