...
Use template from `/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
