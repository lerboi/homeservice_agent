...
- Usage: Reference from command with `@/Users/leroyngzz/Projects/homeservice_agent/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/leroyngzz/Projects/homeservice_agent/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/leroyngzz/Projects/homeservice_agent/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
