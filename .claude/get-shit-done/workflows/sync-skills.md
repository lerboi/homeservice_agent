...
INSTALL_JS_GLOBAL="C:/Users/leheh/.Projects/homeservice_agent/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/leheh/.Projects/homeservice_agent/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
