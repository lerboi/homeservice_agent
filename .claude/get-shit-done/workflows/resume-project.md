...
<required_reading>
@F:/homeservice-agent/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "F:/homeservice-agent/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
