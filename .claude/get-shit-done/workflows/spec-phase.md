...
```bash
INIT=$(node "C:/Users/leheh/.Projects/homeservice_agent/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/leheh/.Projects/homeservice_agent/.claude/get-shit-done/templates/spec.md.
