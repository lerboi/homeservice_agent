...
See F:/homeservice-agent/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using F:/homeservice-agent/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using F:/homeservice-agent/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from F:/homeservice-agent/.claude/get-shit-done/templates/discovery.md
...
Use F:/homeservice-agent/.claude/get-shit-done/templates/discovery.md.
