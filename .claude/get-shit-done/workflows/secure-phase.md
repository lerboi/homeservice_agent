...
```
Agent(
  prompt="Read C:/Users/leheh/.Projects/homeservice_agent/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/leheh/.Projects/homeservice_agent/.claude/get-shit-done/templates/SECURITY.md`
