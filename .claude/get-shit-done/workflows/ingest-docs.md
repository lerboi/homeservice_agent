...
```bash
INIT=$(node "C:/Users/leheh/.Projects/homeservice_agent/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/leheh/.Projects/homeservice_agent/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
