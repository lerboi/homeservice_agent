...
- **Global scope**: `/Users/leroyngzz/Projects/homeservice_agent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/leroyngzz/Projects/homeservice_agent/.claude/notes/`)
...
2. Glob `/Users/leroyngzz/Projects/homeservice_agent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/leroyngzz/Projects/homeservice_agent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/leroyngzz/Projects/homeservice_agent/.claude/notes/` — works in any directory
