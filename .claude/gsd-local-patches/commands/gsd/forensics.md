...
<execution_context>
@F:/homeservice-agent/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @F:/homeservice-agent/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
