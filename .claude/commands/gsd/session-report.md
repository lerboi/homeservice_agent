...
<execution_context>
@F:/homeservice-agent/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @F:/homeservice-agent/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
