...
<execution_context>
@F:/homeservice-agent/.claude/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @F:/homeservice-agent/.claude/get-shit-done/workflows/next.md end-to-end.
</process>
