...
<execution_context>
@F:/homeservice-agent/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @F:/homeservice-agent/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
